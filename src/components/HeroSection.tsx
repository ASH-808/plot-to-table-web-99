    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-16 sm:pt-20">
        <div className="animate-fade-in">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-white mb-4 sm:mb-6 font-lora leading-tight">
            <span className="inline-block animate-pulse text-current break-words">
              {currentText}
            </span>
          ...
          <div className="flex justify-center animate-scale-in px-4">
            <Button 
              size="lg" 
              className="bg-white text-green-700 hover:bg-green-50 px-8 sm:px-12 py-3 sm:py-4 rounded-full text-base sm:text-lg transition-all duration-300 hover:shadow-2xl hover:scale-110 transform w-full sm:w-auto max-w-sm font-medium"
            >
              Start Your Farming →
            </Button>
          </div>
        ...
        <div className="mt-12 sm:mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 animate-slide-up px-4">
          ...
          <div className="text-center transform hover:scale-105 transition-transform duration-300 bg-white/10 backdrop-blur-sm rounded-lg p-4 sm:p-6">
            <div 
              className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2 animate-bounce" 
