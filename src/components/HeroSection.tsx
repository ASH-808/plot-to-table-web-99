...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div 
        className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-green-900/20" 
        style={{
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed animate-slide-up">
            <span className="bg-gradient-to-r from-white to-green-100 bg-clip-text text-transparent">
              Premium Agricultural Plots in Mandya District, Karnataka
            </span>
          </p>
          
          <div className="flex justify-center animate-scale-in">
            <Button size="lg" className="bg-white text-green-700 hover:bg-green-50 px-12 py-4 rounded-full font-semibold text-lg transition-all duration-300 hover:shadow-2xl hover:scale-110 transform">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 animate-slide-up">
          <div className="text-center transform hover:scale-105 transition-transform duration-300">
            <div className="text-4xl font-bold text-white mb-2 animate-bounce">250+</div>
            <div className="text-white/80">Available Plots in Mandya</div>
          </div>
          <div className="text-center transform hover:scale-105 transition-transform duration-300">
            <div className="text-4xl font-bold text-white mb-2 animate-bounce" style={{ animationDelay: '0.2s' }}>
              95%
            </div>
            <div className="text-white/80">Farmer Success Rate</div>
          </div>
          <div className="text-center transform hover:scale-105 transition-transform duration-300">
            <div className="text-4xl font-bold text-white mb-2 animate-bounce" style={{ animationDelay: '0.4s' }}>
              5,000+
            </div>
            <div className="text-white/80">Acres Managed in Karnataka</div>
          </div>
        </div>
      </div>
